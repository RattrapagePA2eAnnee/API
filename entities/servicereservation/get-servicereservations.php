...
function getServicereservations(?array $columns = null): array
{
    if (!is_array($columns)) {
        $columns = [];
    }
    ...
    $authorizedColumns = ["reservation_id", "service_id", "status", "datetime"];
    ...
    $getUserQuery = $databaseConnection->prepare("SELECT * FROM SERVICE_RESERVATION WHERE $whereClause;");
