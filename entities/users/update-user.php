...
function updateUser(string $id, $columns): bool
{
    ...
    $authorizedColumns = ["last_name", "first_name", "password", "email", "role", "subscription_status", "profile_picture", "birth_date","account_creation_time","address","postal_code","city"];
