...
function getParkings(?array $columns = null): array
{
    if (!is_array($columns)) {
        $columns = [];
    }
    ...
    $authorizedColumns = ["id","parking_number","type","length","wingspan"];
    ...
    $getUserQuery = $databaseConnection->prepare("SELECT * FROM PARKINGS WHERE $whereClause;");
